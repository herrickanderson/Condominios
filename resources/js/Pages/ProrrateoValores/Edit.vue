...
const form = useForm({
    criterio: props.prorrateoValor.criterio,
    valor_criterio: props.prorrateoValor.valor_criterio,
    tipo_prorrateo_id: props.prorrateoValor.tipo_prorrateo_id,
   
    id_condominio: props.prorrateoValor.id_condominio,
});

const submit = () => {
    form.put(route('prorrateos.update', props.prorrateoValor.id), {
        onSuccess: () => {
...
<template>
    ...
    <Head title="Editar Prorrateo" />
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center justify-between bg-green-600 p-4 rounded-md">
                <h3 class="text-xl font-semibold text-white">Editar Prorrateo</h3>
        ...
        <div class="py-12">
            <div class="mx-auto max-w-4xl bg-white shadow-lg rounded-xl p-8 border border-gray-200">
                <h3 class="text-2xl font-bold text-gray-700 mb-6 text-center">Editar Prorrateo</h3>
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <!-- Para SuperAdmin, permitir cambiar el condominio -->
                    ...
                    <div class="flex justify-center">
                        <PrimaryButton>Actualizar Prorrateo</PrimaryButton>
                    </div>
                </form>
            </div>
        </div>
